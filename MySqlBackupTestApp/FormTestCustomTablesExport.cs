...
namespace MySqlBackupTestApp
{
    public partial class FormTestCustomTablesExport : Form
    {
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                dataGridView1.Rows[e.RowIndex].Cells[colnSelect.Index].Value =
                    !Convert.ToBoolean(dataGridView1.Rows[e.RowIndex].Cells[colnSelect.Index].Value);
        ...
        private void LoadData()
        {
            ...
            using (MySqlConnection conn = new MySqlConnection(Program.ConnectionString))
            {
                using (MySqlCommand cmd = new MySqlCommand())
                {
                    ...
                    var db = QueryExpress.ExecuteScalarStr(cmd, "SELECT DATABASE();");
        ...
        private void btExportDic_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow r in dataGridView1.Rows)
                ...
                {
                    var tableName = r.Cells[colnTable.Index].Value + "";
                    var sql = r.Cells[colnSql.Index].Value + "";
