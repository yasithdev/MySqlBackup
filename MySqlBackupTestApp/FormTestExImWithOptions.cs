    ...
    public partial class FormExImWithOptions : Form
    {
        ...
        private void button_Backup_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MessageBox.Show("Finished. Dump saved at:" + Environment.NewLine + Environment.NewLine +
                                Program.TargetFile);
            }
            catch (Exception ex)
            {
        ...
        private void button_Restore_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (error == null)
                    ...
                    MessageBox.Show("Finished with errors." + Environment.NewLine + Environment.NewLine + error);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
